...
public class BlogRepositoryTest {
    ...
    @PostConstruct
    public void start(){
        elasticsearchRestTemplate.putMapping(EsBlog.class);
    }
...
//				"关于如何来安装 Elasticsearch，这个请看我的博客 https://com"));
//		esBlogRepository.save(new EsBlog("2","老卫跟你谈谈 Elasticsearch 的几个用法，美妹",
//				"关于如何来用 Elasticsearch，还是得看我的博客 https://com"));  // 关键字"妹"
//		esBlogRepository.save(new EsBlog("3","老卫和你一起学 Elasticsearch",
//				"如何来学习 Elasticsearch，最终看我的博客 https://com，美酒酒")); // 关键字"酒"
